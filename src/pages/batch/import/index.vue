<template>
    <div class="batch-import">
        <div class="batch-title">
            ...
            <p>导入批量案件支持文件格式为 Excel下载&nbsp;&nbsp;<em class="co-FF4949">姓名、性别、身份证号和卡号为必填</em></p>
        ...
        <div class="batch-form">
            <el-form :model="form" :rules="rules"  label-width="400px" label-position="left" ref="form" class="team-msg">
                <el-form-item label="选择客户" prop="client_id">
                    <el-select v-model="form.client_id" @change="clientChange" filterable>
                        <el-option

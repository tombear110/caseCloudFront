...
export default {
    methods: {
        ...
        beginningOfPeriod(d, periodUom, startDow) {
            ...
            // console.log('startDow', startDow)
            let result = null
            switch (periodUom) {
                case 'year':
                    result = new Date(d.getFullYear(), 0)
                    break
                case 'month':
                    result = new Date(d.getFullYear(), d.getMonth())
                    break
                case 'week':
                    result = this.beginningOfWeek(d, startDow)
                    break
                default:
                    result = null
            }
            // console.log('vbbbb-ss',result)
            return result
        },
        ...
        dayDiff(d1, d2) {
            let endDate = new Date(d2.getFullYear(), d2.getMonth(), d2.getDate())
